...
class Sakwood_Product_Language_Meta_Box {
    ...
    public function render_meta_box($post) {
        ...
        $current_language = get_post_meta($post->ID, '_product_language', true);
        ...
        <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #ddd;">
            <h4 style="margin: 0 0 10px 0; font-size: 12px; font-weight: 600; color: #1d2327;">
                <?php _e('Dimensions', 'sakwood-integration'); ?>
            </h4>
            ...
            <div style="margin-bottom: 8px;">
                <label style="display: block; font-size: 11px; color: #646970; margin-bottom: 3px; font-weight: 600;">
                    <?php _e('Thickness (cm)', 'sakwood-integration'); ?>
                </label>
                <input type="number"
                       step="0.1"
            ...
            <div style="margin-bottom: 8px;">
                <label style="display: block; font-size: 11px; color: #646970; margin-bottom: 3px; font-weight: 600;">
                    <?php _e('Width (cm)', 'sakwood-integration'); ?>
                </label>
                <input type="number"
                       step="0.1"
                       name="_product_width"
            ...
            <div style="margin-bottom: 0;">
                <label style="display: block; font-size: 11px; color: #646970; margin-bottom: 3px; font-weight: 600;">
                    <?php _e('Length (m)', 'sakwood-integration'); ?>
                </label>
                <input type="number"
                       step="0.1"
    ...
    public function save_meta_box($post_id) {
        ...
        if (isset($_POST['product_language'])) {
            ...
            if (in_array($language, array('en', 'th'))) {
                update_post_meta($post_id, '_product_language', $language);
            }
        }

        // Save dimensions
        $dimension_fields = array('_product_thickness', '_product_width', '_product_length');
