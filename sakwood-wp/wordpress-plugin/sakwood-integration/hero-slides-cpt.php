...
class Sakwood_Hero_Slides_CPT {
    ...
    public function render_meta_box($post) {
        ...
        $video_url = get_post_meta($post->ID, '_slide_video', true);
        ...
        <div class="sakwood-slide-meta">
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="url" id="slide_video" name="slide_video" value="<?php echo esc_attr($video_url); ?>" class="regular-text" placeholder="https://www.youtube.com/watch?v=xxx or https://example.com/video.mp4" />
                        <p class="description"><?php _e('Enter a YouTube URL or direct MP4 video URL. Video will be used instead of the featured image.', 'sakwood'); ?></p>
                    </td>
                </tr>
                <tr>
