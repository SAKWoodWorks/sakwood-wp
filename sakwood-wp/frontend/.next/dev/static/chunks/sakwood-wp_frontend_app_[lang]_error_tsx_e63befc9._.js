...
function LocaleError({ error, reset, params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LocaleError.useEffect": ()=>{
            params.then({
                "LocaleError.useEffect": (resolved)=>setLang(resolved.lang)
            }["LocaleError.useEffect"]);
        }
    }["LocaleError.useEffect"], [
        params
...
_s(LocaleError, "G+7uRBV4AmcXQgcxcoJr4CJaK/s=");
_c = LocaleError;
var _c;
...
//# sourceMappingURL=sakwood-wp_frontend_app_%5Blang%5D_error_tsx_e63befc9._.js.map