...
"[project]/sakwood-wp/frontend/components/cart/CartItems.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartItems({ lang, dictionary }) {
    ...
    const { items, removeFromCart, updateQuantity } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    if (items.length === 0) {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    item.image?.sourceUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CartItems, "7bL2zLm9cHtK6BUEnbvvOLiDRyg=", false, function() {
    return [
...
"[project]/sakwood-wp/frontend/lib/utils/lineMessage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateCartLineMessage(items, total, lang) {
    if (!items || items.length === 0) {
        ...
        const lineId = __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$config$2f$chatConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultChatConfig"].platforms.line.url.replace('@', '');
...
"[project]/sakwood-wp/frontend/components/cart/CartSummary.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$utils$2f$lineMessage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/sakwood-wp/frontend/lib/utils/lineMessage.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function CartSummary({ lang, dictionary }) {
    ...
    const { items, getCartTotal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const lineUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartSummary.useMemo[lineUrl]": ()=>{
            if (items.length === 0) return '';
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$utils$2f$lineMessage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateCartLineMessage"])(items, subtotal, lang);
        }
    }["CartSummary.useMemo[lineUrl]"], [
        items,
        subtotal,
    ...
    const shippingBreakdown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartSummary.useMemo[shippingBreakdown]": ()=>{
            ...
            const getProvinceRate = {
                "CartSummary.useMemo[shippingBreakdown].getProvinceRate": (province)=>{
                    const rates = {
                        'Pathumtani': 5000,
                        'Nonthaburi': 5000,
                        'Samut Prakan': 5000,
            ...
            }["CartSummary.useMemo[shippingBreakdown].getProvinceRate"];
            const baseRate = getProvinceRate(selectedProvince);
            // Determine truck type and surcharge
            const determineTruckType = {
                "CartSummary.useMemo[shippingBreakdown].determineTruckType": ()=>{
                    let totalLength = 0;
                    let totalVolume = 0;
                    items.forEach({
                        "CartSummary.useMemo[shippingBreakdown].determineTruckType": (item)=>{
                            const length = typeof item.length === 'string' ? parseFloat(item.length) || 0 : item.length || 0;
                            const volume = item.volume || 0;
                            totalLength += length * item.quantity;
                            totalVolume += volume * item.quantity;
                    ...
                    const hasLongItem = items.some({
                        "CartSummary.useMemo[shippingBreakdown].determineTruckType.hasLongItem": (item)=>{
                            const length = typeof item.length === 'string' ? parseFloat(item.length) || 0 : item.length || 0;
                            return length >= 6;
                        }
                    }["CartSummary.useMemo[shippingBreakdown].determineTruckType.hasLongItem"]);
                    const totalLengthExceedsLimit = totalLength > 12;
                    const totalVolumeExceedsLimit = totalVolume > 5;
                    if (hasLongItem || totalLengthExceedsLimit || totalVolumeExceedsLimit) {
                        return {
                    ...
                    const hasMediumItem = items.some({
                        "CartSummary.useMemo[shippingBreakdown].determineTruckType.hasMediumItem": (item)=>{
                            const length = typeof item.length === 'string' ? parseFloat(item.length) || 0 : item.length || 0;
                            return length >= 3 && length < 6;
                        }
                    }["CartSummary.useMemo[shippingBreakdown].determineTruckType.hasMediumItem"]);
                    const totalLengthExceedsMedium = totalLength > 6;
                    const totalVolumeExceedsMedium = totalVolume > 2;
                    if (hasMediumItem || totalLengthExceedsMedium || totalVolumeExceedsMedium) {
                        return {
            ...
            const getPriceTier = {
                "CartSummary.useMemo[shippingBreakdown].getPriceTier": ()=>{
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            provinces.map((province)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: province,
                                    children: province
                                }, province, false, {
                                    fileName: "[project]/sakwood-wp/frontend/components/cart/CartSummary.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    shippingBreakdown && shippingBreakdown.finalCost > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    shippingBreakdown && shippingBreakdown.finalCost === 0 && subtotal >= 10000 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    !shippingBreakdown && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex justify-between items-center",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-gray-600",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-3",
                children: [
                    items.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: [
                                    items.slice(0, 5).map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            className: "text-gray-600",
                                            children: [
                                                "• ",
                                                item.name,
                                    ...
                                    items.length > 5 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
_s(CartSummary, "vcT5qEqq5fIoZO+d6hhSLCdoixs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
...
"[project]/sakwood-wp/frontend/components/cart/CartActions.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartActions({ lang, dictionary }) {
    _s();
    const { cart: dict } = dictionary;
    const { items, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    if (items.length === 0) {
        return null;
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CartActions, "ZR3lR/AKY+gcu8VQPCZQ2CHZp2U=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
_c = CartActions;
var _c;
__turbopack_context__.k.register(_c, "CartActions");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=sakwood-wp_frontend_3e95a945._.js.map