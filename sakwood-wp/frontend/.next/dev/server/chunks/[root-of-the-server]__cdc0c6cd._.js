...
"[project]/sakwood-wp/frontend/app/api/customer-crm/tasks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const wpUrl = userId ? `${WORDPRESS_API_URL}/sakwood/v1/customer/crm/tasks?user_id=${userId}` : `${WORDPRESS_API_URL}/sakwood/v1/customer/crm/tasks`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cdc0c6cd._.js.map