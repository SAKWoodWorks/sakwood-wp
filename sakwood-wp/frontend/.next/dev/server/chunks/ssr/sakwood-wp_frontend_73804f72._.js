...
"[project]/sakwood-wp/frontend/lib/services/productService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getProducts(language = 'th', categorySlug, sortBy) {
    try {
        ...
        let url = `${baseUrl}/wp-json/sakwood/v1/products?language=${language}&per_page=${__TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$config$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["APP_CONFIG"].productsPerPage}`;
 ...
 */ async function getProductsViaGraphQL(language = 'th') {
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$graphql$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["graphqlRequest"])(__TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$graphql$2f$queries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GET_PRODUCTS_QUERY"], {
        first: 10
    });
 ...
 */ async function getProductBySlugViaGraphQL(slug) {
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$graphql$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["graphqlRequest"])(__TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$graphql$2f$queries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GET_PRODUCT_QUERY"], {
        slug
    });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$services$2f$productService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/sakwood-wp/frontend/lib/services/productService.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function ShopPage({ lang, dictionary, initialProducts, initialCategories }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadProducts() {
            setIsLoading(true);
            const fetchedProducts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$sakwood$2d$wp$2f$frontend$2f$lib$2f$services$2f$productService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProducts"])(lang, selectedCategory || undefined, sortBy || undefined);
...
//# sourceMappingURL=sakwood-wp_frontend_73804f72._.js.map