...
"[project]/sakwood-wp/frontend/app/api/customer-addresses/[addressId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const response = await fetch(`${WORDPRESS_API_URL}/sakwood/v1/customer/addresses/${addressId}`, {
            method: 'POST',
            headers: {
...
async function DELETE(request, { params }) {
    try {
        ...
        const wpUrl = userId ? `${WORDPRESS_API_URL}/sakwood/v1/customer/addresses/${addressId}?user_id=${userId}` : `${WORDPRESS_API_URL}/sakwood/v1/customer/addresses/${addressId}`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97867cda._.js.map