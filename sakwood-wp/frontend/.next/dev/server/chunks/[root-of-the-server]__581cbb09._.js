...
"[project]/sakwood-wp/frontend/app/api/customer-addresses/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const wpUrl = userId ? `${WORDPRESS_API_URL}/sakwood/v1/customer/addresses?user_id=${userId}` : `${WORDPRESS_API_URL}/sakwood/v1/customer/addresses`;
...
async function POST(request) {
    try {
        ...
        const cookieHeader = request.headers.get('cookie') || '';
        const response = await fetch(`${WORDPRESS_API_URL}/sakwood/v1/customer/addresses`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Cookie': cookieHeader
...
//# sourceMappingURL=%5Broot-of-the-server%5D__581cbb09._.js.map